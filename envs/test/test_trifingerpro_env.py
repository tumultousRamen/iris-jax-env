from envs.aarchive.trifingerpro_env import MjSimulator
import torch
from utils import torch_transform
import numpy as np
from envs.aarchive.trifingerpro_fkin import f0tip_pos_fd_fn, f120tip_pos_fd_fn, f240tip_pos_fd_fn


class param:
    def __init__(self):
        self.model_path_ = 'envs/sources/xml/trifingerpro_foambrick_env.xml'
        ...
        self.init_obj_qpos_ = np.array([-0.03, 0.0, 0.023, 1, 0, 0, 0])
